...
--      #pragma implemented(d1li,vhdl,d1li_ram)
--
-- This model was part of the Caph standard VHDL library up to v2.8.5
-- It was then moved in the [contrib] repository because the expected synthetizer-level
...
architecture FSM of d1li_ram is
